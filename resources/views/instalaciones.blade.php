...
<div class="instalaciones-page" style="padding-top: 120px; min-height: 100vh; background-color: var(--color-bg); color: var(--color-text-primary); transition: background-color 0.3s ease;">
    ...
    <!-- ==========================================
       BLOQUE SOCIAL (Bento Grid Asimétrico)
       ========================================== -->
    <section class="premium-section bg-obsidian" style="padding: 6rem 1.5rem 8rem 1.5rem;" id="social">
        <div style="max-width: 1200px; margin: 0 auto;">
            <div class="section-header-editorial" style="margin-bottom: 4rem;">
                <span style="font-family: var(--font-alt); font-size: 0.75rem; letter-spacing: 2px; text-transform: uppercase; color: var(--color-accent-gold); display: block; margin-bottom: 0.5rem;">Comunidad & Encuentro</span>
                <h2 style="font-size: 2.2rem; color: var(--color-text-primary);">Club Social</h2>
                <p style="color: var(--color-text-secondary); font-size: 0.95rem;">Exclusivos espacios diseñados para convivir, relajarse y disfrutar de la mejor gastronomía y eventos familiares.</p>
            </div>

            <div class="bento-grid">
                
                <!-- Tarjeta 1: Casa Club (Ancho 5) -->
                <div class="bento-item bento-col-5" style="cursor: pointer;" onclick="window.location.href='{{ url('/instalaciones/casa-club') }}'">
                    <div class="bento-img-container" style="height: 280px; overflow: hidden; position: relative;">
                        <img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80" alt="Casa Club Vista Verde" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s cubic-bezier(0.16, 1, 0.3, 1);">
                    </div>
                    <div class="bento-card-content" style="padding: 2rem; display: flex; flex-direction: column; flex-grow: 1;">
                        <h3 style="font-family: var(--font-editorial); font-size: 1.7rem; color: var(--color-text-primary);">Casa Club</h3>
                        <p style="color: var(--color-text-secondary); font-size: 0.95rem; line-height: 1.6; margin-bottom: 1.5rem; flex-grow: 1;">Salones ejecutivos y comedores exclusivos con elegantes acabados y chimenea central.</p>
                        <a href="{{ url('/instalaciones/casa-club') }}" class="btn-link" style="text-decoration: none; color: var(--color-text-primary); font-weight: 600; font-size: 0.85rem;">Explorar Área &rarr;</a>
                    </div>
                </div>

                <!-- Tarjeta 2: Spa & Bienestar (Ancho 7) -->
                <div class="bento-item bento-col-7" style="cursor: pointer;" onclick="window.location.href='{{ url('/instalaciones/spa-bienestar') }}'">
                    <div class="bento-img-container" style="height: 280px; overflow: hidden; position: relative;">
                        <img src="https://images.unsplash.com/photo-1519699047748-de8e457a634e?auto=format&fit=crop&w=800&q=80" alt="Spa Vista Verde" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s cubic-bezier(0.16, 1, 0.3, 1);">
                    </div>
                    <div class="bento-card-content" style="padding: 2rem; display: flex; flex-direction: column; flex-grow: 1;">
                        <h3 style="font-family: var(--font-editorial); font-size: 1.7rem; color: var(--color-text-primary);">Spa & Bienestar</h3>
                        <p style="color: var(--color-text-secondary); font-size: 0.95rem; line-height: 1.6; margin-bottom: 1.5rem; flex-grow: 1;">Un santuario de tranquilidad dedicado al cuidado de su cuerpo con masajes y tratamientos holísticos.</p>
                        <a href="{{ url('/instalaciones/spa-bienestar') }}" class="btn-link" style="text-decoration: none; color: var(--color-text-primary); font-weight: 600; font-size: 0.85rem;">Explorar Área &rarr;</a>
                    </div>
                </div>

                <!-- Tarjeta 3: Terraza del Lago (Ancho 7) -->
                <div class="bento-item bento-col-7" style="cursor: pointer;" onclick="window.location.href='{{ url('/instalaciones/terraza-lago') }}'">
                    <div class="bento-img-container" style="height: 280px; overflow: hidden; position: relative;">
                        <img src="https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?auto=format&fit=crop&w=800&q=80" alt="Terraza Vista Verde" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s cubic-bezier(0.16, 1, 0.3, 1);">
                    </div>
                    <div class="bento-card-content" style="padding: 2rem; display: flex; flex-direction: column; flex-grow: 1;">
                        <h3 style="font-family: var(--font-editorial); font-size: 1.7rem; color: var(--color-text-primary);">Terraza del Lago</h3>
                        <p style="color: var(--color-text-secondary); font-size: 0.95rem; line-height: 1.6; margin-bottom: 1.5rem; flex-grow: 1;">Espectacular mirador para atardeceres memorables, mixología sofisticada y maridaje al aire libre.</p>
                        <a href="{{ url('/instalaciones/terraza-lago') }}" class="btn-link" style="text-decoration: none; color: var(--color-text-primary); font-weight: 600; font-size: 0.85rem;">Explorar Área &rarr;</a>
                    </div>
                </div>

                <!-- Tarjeta 4: Salón de Eventos (Ancho 5) -->
                <div class="bento-item bento-col-5" style="cursor: pointer;" onclick="window.location.href='{{ url('/instalaciones/salon-eventos') }}'">
                    <div class="bento-img-container" style="height: 280px; overflow: hidden; position: relative;">
                        <img src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&w=800&q=80" alt="Salón de Eventos Vista Verde" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.8s cubic-bezier(0.16, 1, 0.3, 1);">
                    </div>
                    <div class="bento-card-content" style="padding: 2rem; display: flex; flex-direction: column; flex-grow: 1;">
                        <h3 style="font-family: var(--font-editorial); font-size: 1.7rem; color: var(--color-text-primary);">Salón de Eventos</h3>
                        <p style="color: var(--color-text-secondary); font-size: 0.95rem; line-height: 1.6; margin-bottom: 1.5rem; flex-grow: 1;">Espacio de gala versátil con equipamiento tecnológico para eventos sociales y corporativos de clase mundial.</p>
                        <a href="{{ url('/instalaciones/salon-eventos') }}" class="btn-link" style="text-decoration: none; color: var(--color-text-primary); font-weight: 600; font-size: 0.85rem;">Explorar Área &rarr;</a>
                    </div>
                </div>
