...
@section('title', 'Aviso de Privacidad — Vista Verde Country Club')
@section('meta_description', 'Aviso de Privacidad de Vista Verde Country Club. Conoce cómo protegemos tus datos personales.')
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const hasPdf = {{ setting('privacy_pdf') ? 'true' : 'false' }};
        const pdfUrl = hasPdf ? '{{ setting("privacy_pdf") ? asset("storage/" . setting("privacy_pdf")) : '' }}' : null;
