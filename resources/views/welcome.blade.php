            ...
            <div class="contacto-grid-wrapper" style="display: grid; grid-template-columns: 1fr 1.1fr; gap: 3.5rem; align-items: center;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 2.5rem; border-left: 2px solid var(--color-accent-gold); padding-left: 1.5rem; display: flex; flex-direction: column; gap: 0.5rem;">
                        <span style="font-family: var(--font-alt); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px; color: var(--color-text-secondary); opacity: 0.7;">{{ setting('contact_address_label', 'Dirección Principal') }}</span>
                        <p style="margin: 0; font-family: var(--font-base); font-size: 1.05rem; color: var(--color-text-primary); font-weight: 600;">{{ setting('contact_address_name', 'Casa Club Vista Verde') }}</p>
                        <p style="margin: 0; color: var(--color-text-secondary); font-size: 0.95rem; line-height: 1.5;">
                            {{ setting('contact_address_line1', 'Carretera Federal México-Tehuacán Km. 252') }}<br>
                            {{ setting('contact_address_line2', 'San Nicolás Tetitzintla, 75710 Tehuacán, Pue.') }}
                        </p>
                    </div>

                    <a href="{{ setting('contact_maps_url', '#') }}" target="_blank" rel="noopener" class="btn-link" style="text-decoration: none; color: var(--color-accent-gold); font-family: var(--font-alt); font-size: 0.8rem; letter-spacing: 1.5px; text-transform: uppercase; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateX(5px)'" onmouseout="this.style.transform='translateX(0)'">
                        {{ setting('contact_maps_btn_text', 'Cómo Llegar en Google Maps →') }}
                    </a>
                </div>
                ...
                <div>
                    ...
                    <div style="margin-bottom: 2rem;">
                        <span style="font-family: var(--font-alt); font-size: 0.75rem; letter-spacing: 2px; text-transform: uppercase; color: var(--color-accent-gold); display: block; margin-bottom: 1rem;">
                            {{ setting('contact_social_heading', 'Síguenos en redes') }}
                        </span>
                        <div style="display: flex; gap: 1.25rem;">
                            @if(setting('social_facebook'))
                            <a href="{{ setting('social_facebook') }}" target="_blank" rel="noopener" aria-label="Facebook" style="color: var(--color-text-secondary); transition: color 0.3s ease, transform 0.3s ease; display: inline-flex;" onmouseover="this.style.color='var(--color-accent-gold)'; this.style.transform='translateY(-2px)'" onmouseout="this.style.color=''; this.style.transform=''">
                            ...
                            <a href="{{ setting('social_instagram') }}" target="_blank" rel="noopener" aria-label="Instagram" style="color: var(--color-text-secondary); transition: color 0.3s ease, transform 0.3s ease; display: inline-flex;" onmouseover="this.style.color='var(--color-accent-gold)'; this.style.transform='translateY(-2px)'" onmouseout="this.style.color=''; this.style.transform=''">
                    ...
                    <div class="map-iframe-container" style="width: 100%; height: 450px; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 25px rgba(0,0,0,0.05);">
                        <iframe src="{{ setting('contact_maps_embed', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.002589867335!2d-97.41330921649934!3d18.483541887826103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c5a2cf77bbf7f9%3A0x992163d342c0d985!2sCasa%20Club%20Vista%20Verde%20Country%20Club!5e0!3m2!1ses-419!2smx!4v1783023157035!5m2!1ses-419!2smx') }}" width="100%" height="100%" style="border:0; display: block;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                    </div>
                </div>
