        ...
        <div style="max-width: 1200px; margin: 0 auto;">
            <div class="contacto-grid-wrapper" style="display: grid; grid-template-columns: 1fr 1.1fr; gap: 3.5rem; align-items: center;">
                ...
                <div>
                    ...
                    <a href="{{ safe_url(setting('contact_maps_url', '#')) }}" target="_blank" rel="noopener" class="btn-link" style="text-decoration: none; color: var(--color-accent-gold); font-family: var(--font-alt); font-size: 0.8rem; letter-spacing: 1.5px; text-transform: uppercase; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateX(5px)'" onmouseout="this.style.transform='translateX(0)'">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <div style="display: flex; gap: 1.25rem;">
                            ...
                            <a href="{{ safe_url(setting('social_facebook')) }}" target="_blank" rel="noopener" aria-label="Facebook" style="color: var(--color-text-secondary); transition: color 0.3s ease, transform 0.3s ease; display: inline-flex;" onmouseover="this.style.color='var(--color-accent-gold)'; this.style.transform='translateY(-2px)'" onmouseout="this.style.color=''; this.style.transform=''">
                            ...
                            <a href="{{ safe_url(setting('social_instagram')) }}" target="_blank" rel="noopener" aria-label="Instagram" style="color: var(--color-text-secondary); transition: color 0.3s ease, transform 0.3s ease; display: inline-flex;" onmouseover="this.style.color='var(--color-accent-gold)'; this.style.transform='translateY(-2px)'" onmouseout="this.style.color=''; this.style.transform=''">
                    ...
                    <div class="map-iframe-container" style="width: 100%; height: 450px; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 25px rgba(0,0,0,0.05);">
                        <iframe src="{{ $mapsEmbed ?: $defaultMapEmbed }}" width="100%" height="100%" style="border:0; display: block;" allowfullscreen="" loading="lazy" title="Mapa de ubicación de Vista Verde Country Club" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                    </div>
                </div>
