...
<div class="pdf-viewer-page">
    ...
    <div class="pdf-dock" id="pdf-dock">
        ...
        <a href="{{ setting('terms_pdf') ? route('pdf.show', ['path' => setting('terms_pdf')]) : '#' }}" download class="pdf-btn" id="download-pdf" title="Descargar Términos y Condiciones">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<script type="module" nonce="{{ csp_nonce() }}">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const pdfUrl = hasPdf ? @json(setting('terms_pdf') ? route('pdf.show', ['path' => setting('terms_pdf')]) : '') : null;
