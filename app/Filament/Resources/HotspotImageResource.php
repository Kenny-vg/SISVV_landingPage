            ...
            ->schema([
                Forms\Components\View::make('filament.components.section-guide')
                    ->viewData([
                        ...
                        'description' => 'Puedes cambiar la etiqueta, la posición (X/Y), la imagen y la publicación de cada punto. La clave identifica al punto y no se puede modificar después de crearlo.',
                    ])
                    ->columnSpanFull(),
