...
<section class="premium-section events-home-section fade-in-section" id="eventos">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; flex-wrap: wrap; gap: 2rem;">
        <div class="section-header-editorial" style="margin-bottom: 0; max-width: 700px;">
            <span style="font-family: var(--font-alt); font-size: 0.75rem; letter-spacing: 2px; text-transform: uppercase; color: var(--color-accent-gold); display: block; margin-bottom: 0.8rem;"><?php echo e(setting('events_label', 'Club Vista Verde')); ?></span>
            <h2><?php echo setting('events_heading', 'Eventos &<br><span>Tipos de evento.</span>'); ?></h2>
            <p>
                <?php echo e(setting('events_subtext', 'Actividades exclusivas, torneos y celebraciones diseñadas para la comunidad del club. Vive experiencias únicas junto a los tuyos.')); ?>
    ...
    <div class="facilities-carousel-wrapper" id="events-carousel-wrapper">
        <div class="facilities-carousel-track" id="events-carousel-track">
            ...
            <a href="<?php echo e(route('eventos.show', $event->slug)); ?>" class="bento-fullbleed event-card-item">
                <img
                    src="<?php echo e($event->image ? asset('storage/' . $event->image) : asset('images/hero.jpg')); ?>"
    ...
    <div style="text-align: center; margin-top: 2.5rem;">
        <a href="<?php echo e(route('eventos.index')); ?>" class="btn-gold" style="text-decoration: none; display: inline-block;">
            <?php echo e(setting('events_all_link_text', 'Ver todos los eventos')); ?>
...
<?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views\components\events-section.blade.php ENDPATH**/ ?>