<?php $__env->startSection('title', 'Términos y Condiciones — Vista Verde Country Club'); ?>
<?php $__env->startSection('meta_description', 'Términos y Condiciones de Vista Verde Country Club. Conoce las reglas y políticas de uso del club.'); ?>
...
<div class="pdf-viewer-page">
    ...
    <div class="pdf-dock" id="pdf-dock">
        ...
        <a href="<?php echo e(setting('terms_pdf') ? asset('storage/' . setting('terms_pdf')) : '#'); ?>" download class="pdf-btn" id="download-pdf" title="Descargar Términos y Condiciones">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<script type="module">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const hasPdf = <?php echo json_encode((bool) setting('terms_pdf'), 15, 512) ?>;
        const pdfUrl = hasPdf ? <?php echo json_encode(setting('terms_pdf') ? asset('storage/' . setting('terms_pdf')) : '', 15, 512) ?> : null;
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views/terminos-condiciones.blade.php ENDPATH**/ ?>