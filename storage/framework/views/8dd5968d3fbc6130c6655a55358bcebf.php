<?php $__env->startSection('title', $event->title . ' — Vista Verde Country Club'); ?>
...
<div class="evento-pdf-page">
    ...
    <div class="evento-pdf-split">
        ...
        <aside class="evento-pdf-sidebar">
            ...
            <a href="<?php echo e(route('eventos.index')); ?>" class="evento-pdf-back">
            ...
            <span class="evento-pdf-category-badge"><?php echo e($event->category); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <h1 class="evento-pdf-title"><?php echo e($event->title); ?></h1>
            ...
            <div class="evento-pdf-description">
                <?php echo e(nl2br(e($event->description))); ?>
            ...
            <a href="<?php echo e(asset('storage/' . $event->pdf_path)); ?>" target="_blank" class="evento-pdf-download-btn">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <main class="evento-pdf-main">
            ...
            <div class="pdf-dock" id="pdf-dock">
                ...
                <div class="pdf-divider"></div>
                <a href="<?php echo e(asset('storage/' . $event->pdf_path)); ?>" download class="pdf-btn" id="download-pdf" title="Descargar PDF">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                    </svg>
                </a>
...
<script type="module">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const pdfUrl = <?php echo json_encode(asset('storage/' . $event->pdf_path), 15, 512) ?>;
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views\eventos\show.blade.php ENDPATH**/ ?>