...
<div class="pdf-viewer-page">
    ...
    <a href="<?php echo e(url('/lector')); ?>" class="pdf-back-btn" id="pdf-back-btn">
    ...
    <header class="pdf-header-editorial">
        <span class="pdf-category-tag"><?php echo e($category->name); ?></span>
        <h1>Menú de <?php echo e($category->name); ?></h1>
        <p><?php echo e(strip_tags($category->description)); ?></p>
    ...
    <div class="pdf-dock" id="pdf-dock">
        ...
        <!-- Botón de Descarga -->
        <a href="<?php echo e($category->pdf ? asset('storage/'.$category->pdf) : '#'); ?>" download class="pdf-btn" id="download-pdf" title="Descargar Menú">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<script type="module">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const categorySlug = <?php echo json_encode($category->slug, 15, 512) ?>;
        const categoryName = <?php echo json_encode($category->name, 15, 512) ?>;
        const categoryTitle = <?php echo json_encode('Menú de '.$category->name, 15, 512) ?>;
        const categoryDesc = <?php echo json_encode(strip_tags($category->description), 15, 512) ?>;
        ...
        const hasPdf = <?php echo e($category->pdf ? 'true' : 'false'); ?>;
        const pdfUrl = hasPdf ? <?php echo json_encode($category->pdf ? asset('storage/'.$category->pdf) : '', 15, 512) ?> : null;
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views\lector\pdf_viewer.blade.php ENDPATH**/ ?>