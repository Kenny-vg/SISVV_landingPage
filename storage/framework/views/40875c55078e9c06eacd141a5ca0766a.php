<?php $__env->startSection('title', $area->title . ' — Instalaciones Vista Verde Country Club'); ?>
...
<div class="instalacion-detalle-page" style="padding-top: 120px; min-height: 100vh; background-color: var(--color-bg); color: var(--color-text-primary); transition: background-color 0.3s ease;">
    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 2rem 1.5rem 8rem 1.5rem;">
        ...
        <!-- Botón Volver -->
        <a href="<?php echo e(url('/instalaciones')); ?>" style="text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; color: var(--color-accent-gold); font-family: var(--font-alt); font-size: 0.85rem; letter-spacing: 1px; text-transform: uppercase; margin-bottom: 3rem; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateX(-5px)'" onmouseout="this.style.transform='translateX(0)'">
        ...
        <div class="detalle-grid-container" style="display: grid; grid-template-columns: 1.2fr 1.8fr; gap: 4rem; align-items: start;">
            ...
            <div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($area->panorama_path): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (panoEl && typeof pannellum !== 'undefined') {
        pannellum.viewer('pano', {
            ...
            panorama: <?php echo json_encode(asset('storage/' . $area->panorama_path), 15, 512) ?>,
            autoLoad: true,
            compass: true,
            showZoomCtrl: false,
            keyboardZoom: true,
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views/instalaciones/show.blade.php ENDPATH**/ ?>