...
<section class="premium-section bg-obsidian fade-in-section" id="clases">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; flex-wrap: wrap; gap: 2rem;">
        <div class="section-header-editorial" style="margin-bottom: 0; max-width: 700px;">
            <h2><?php echo setting('facilities_heading', 'Clases &<br><span>Disciplinas.</span>'); ?></h2>
            <p>
                <?php echo e(setting('facilities_subtext', 'Instructores certificados, metodología de élite y espacios de primer nivel para elevar tu rendimiento y bienestar en cada sesión.')); ?>
            ...
            <a href="<?php echo e(url('/clases/'.$discipline->slug)); ?>" class="bento-fullbleed">
                ...
                <div class="bento-fullbleed-content">
                    ...
                    <div class="bento-fullbleed-bottom">
                        ...
                        <span class="bento-fullbleed-link"><?php echo e(setting('facilities_link_text', 'Ver Clase →')); ?></span>
                    </div>
                </div>
            </a>
    ...
    <div style="text-align: center; margin-top: 2.5rem;">
        <a href="<?php echo e(url('/clases')); ?>" class="btn-gold" style="text-decoration: none; display: inline-block;">
            <?php echo e(setting('facilities_all_link_text', 'Ver todas las clases')); ?>
...
<?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views/components/facilities-section.blade.php ENDPATH**/ ?>