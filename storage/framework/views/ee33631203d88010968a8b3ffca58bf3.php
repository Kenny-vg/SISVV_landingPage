<?php $__env->startSection('title', 'Aviso de Privacidad — Vista Verde Country Club'); ?>
<?php $__env->startSection('meta_description', 'Aviso de Privacidad de Vista Verde Country Club. Conoce cómo protegemos tus datos personales.'); ?>

<?php $__env->startSection('content'); ?>
<div class="pdf-viewer-page">

    <a href="<?php echo e(url('/')); ?>" class="pdf-back-btn" id="pdf-back-btn">
    ...
    <div class="pdf-dock" id="pdf-dock">
        ...
        <a href="<?php echo e(setting('privacy_pdf') ? asset('storage/' . setting('privacy_pdf')) : '#'); ?>" download class="pdf-btn" id="download-pdf" title="Descargar Aviso de Privacidad">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<script type="module">
    import * as pdfjsLib from '<?php echo e(asset('js/pdf/pdf.min.mjs')); ?>';
    pdfjsLib.GlobalWorkerOptions.workerSrc = '<?php echo e(asset('js/pdf/pdf.worker.min.mjs')); ?>';
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const hasPdf = <?php echo json_encode((bool) setting('privacy_pdf'), 15, 512) ?>;
        const pdfUrl = hasPdf ? <?php echo json_encode(setting('privacy_pdf') ? asset('storage/' . setting('privacy_pdf')) : '', 15, 512) ?> : null;

        const downloadBtn = document.getElementById('download-pdf');
        if (downloadBtn) {
            downloadBtn.href = pdfUrl || '#';
            downloadBtn.setAttribute('download', 'aviso-de-privacidad.pdf');
            downloadBtn.title = 'Descargar Aviso de Privacidad';
        }
        ...
        if (!pdfUrl) {
            ...
            ctx.fillText('No hay aviso de privacidad disponible', canvas.width / 2, 100);
            return;
        }
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views\aviso-privacidad.blade.php ENDPATH**/ ?>