...
<section class="premium-section bg-obsidian fade-in-section" id="nosotros">
    <div class="about-home-grid">
        <div>
            <span style="font-family: var(--font-alt); font-size: 0.75rem; letter-spacing: 3px; text-transform: uppercase; color: var(--color-accent-gold); display: block; margin-bottom: 1rem;"><?php echo e($aboutTitle); ?></span>
            ...
            <a href="<?php echo e(url('/nosotros')); ?>" class="btn-gold" style="text-decoration: none; display: inline-block; margin-top: 0.5rem;">
                Conócenos más →
            </a>
        </div>
        <div style="border-radius: 24px; overflow: hidden; height: 500px; background-color: var(--color-surface);">
            <img src="<?php echo e($section?->image ? asset('storage/' . $section->image) : asset('images/about.jpg')); ?>" alt="Vista Verde Country Club" style="width: 100%; height: 100%; max-width: 100%; object-fit: cover; display: block;">
        </div>
    </div>
</section>
<?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views/components/about-section.blade.php ENDPATH**/ ?>