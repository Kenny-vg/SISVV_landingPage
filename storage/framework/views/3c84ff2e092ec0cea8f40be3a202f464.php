...
<div class="admin-floating-widget" id="adminWidget">
    ...
    <div class="admin-widget-menu">
        <a href="<?php echo e(url('/admin')); ?>" class="admin-widget-item">
...
<?php /**PATH C:\Users\mezaX\OneDrive\Desktop\Landing page VV\resources\views/components/admin-widget.blade.php ENDPATH**/ ?>