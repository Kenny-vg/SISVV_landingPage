...
class ContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            'about_intro' => [
                'title' => 'Quiénes somos',
                'heading' => 'Un refugio privado',
                'heading_accent' => 'donde el deporte y la naturaleza convergen.',
            ...
            PageSection::updateOrCreate(['key' => $key], [
                ...
                'heading_accent' => $data['heading_accent'] ?? null,
        ...
        $memberships = [
            [
                ...
                'tipo' => 'MEN',
                'area' => 'Campo de Golf',
                'members_text' => '1 Persona (Individual)',
                'has_golf_access' => true,
                'sort_order' => 1,
                'is_published' => true,
                'show_price' => true,
                'is_featured' => false,
